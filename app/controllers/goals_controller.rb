class GoalsController < ApplicationController
  ...
  def create_row_from_improvement_plan
    ...
    if @goal.valid?
      ...
      redirect_to("/improvement_plans/#{@goal.plan_id}", notice: "Goal created successfully.")
    else
      render("goal_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def destroy_row_from_plan
    ...
    redirect_to("/improvement_plans/#{@goal.plan_id}", notice: "Goal deleted successfully.")
  end
